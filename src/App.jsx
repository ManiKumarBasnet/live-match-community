...
.metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin-bottom:22px}.metric{background:rgba(255,255,255,.88);border:1px solid rgba(211,219,230,.78);border-radius:22px;padding:18px;box-shadow:var(--shadow-xs)}.metric-accent{position:relative;overflow:hidden;background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(245,247,250,.94));border-color:rgba(188,233,209,.95)}.metric-accent::before{content:"";position:absolute;inset:0 auto auto 0;width:100%;height:4px;background:linear-gradient(90deg,var(--green),var(--blue),var(--amber));opacity:.92}.metric-icon{width:40px;height:40px;border-radius:15px;display:grid;place-items:center;margin-bottom:14px}.metric-accent .metric-icon{width:46px;height:46px;border-radius:16px}.metric-icon svg{width:19px;height:19px}.metric-accent .metric-icon svg{width:20px;height:20px}.metric-icon-compact{width:30px;height:30px}.metric-icon-compact svg{width:14px;height:14px}.metric-value{font-family:var(--font-display);font-size:30px;line-height:1;font-weight:800;letter-spacing:-.04em}.metric-accent .metric-value{font-size:34px}.metric-value.small{font-size:20px}.metric-label{font-size:12px;color:var(--muted);font-weight:800;margin-top:6px}.metric-note{font-size:11px;color:var(--faint);font-weight:700;margin-top:8px;line-height:1.35}.dashboard-grid{display:grid;grid-template-columns:minmax(0,1fr) 430px;gap:22px;align-items:start}.stack{display:flex;flex-direction:column;gap:22px}.stand-sticky{position:sticky;top:98px}
.stats-hero{position:relative;overflow:hidden;padding:22px 24px;margin-bottom:18px;background:linear-gradient(135deg,rgba(7,16,29,.98),rgba(12,72,52,.94));color:#eef7ff;border:0;box-shadow:0 26px 56px rgba(7,16,29,.18)}.stats-hero::before{content:"";position:absolute;inset:-18% -8% auto auto;width:340px;height:340px;background:radial-gradient(circle at 35% 35%,rgba(255,255,255,.11),transparent 58%),radial-gradient(circle at 62% 66%,rgba(94,226,164,.16),transparent 58%);filter:blur(2px)}.stats-hero::after{content:"";position:absolute;inset:auto auto -28% -8%;width:320px;height:320px;background:radial-gradient(circle at 45% 45%,rgba(139,184,255,.15),transparent 60%);filter:blur(3px)}.stats-hero-top{position:relative;z-index:1;display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.stats-eyebrow{display:inline-flex;align-items:center;gap:8px;border-radius:999px;padding:6px 10px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);font-size:10.5px;font-weight:900;letter-spacing:.12em;text-transform:uppercase;color:#b7c9d9}.stats-eyebrow svg{width:14px;height:14px;color:#5ee2a4}.stats-hero h2{font-family:var(--font-display);font-size:30px;line-height:1;letter-spacing:-.05em;margin:12px 0 10px}.stats-copy{max-width:640px;font-size:14px;line-height:1.6;color:#b6c7d7}.stats-badges{display:flex;flex-wrap:wrap;gap:8px;justify-content:flex-end;max-width:430px}.stats-badge{display:inline-flex;align-items:center;gap:8px;padding:8px 10px 8px 9px;border-radius:999px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1);font-size:11.5px;font-weight:850;color:#ecf3f9;max-width:100%}.stats-badge svg{width:12px;height:12px;color:#5ee2a4}.stats-badge:nth-child(2) svg{color:#8bb8ff}.stats-badge:nth-child(3) svg{color:#f6c55e}.stats-mini-icon{width:18px;height:18px;border-radius:999px;display:grid;place-items:center;background:rgba(255,255,255,.08);flex:0 0 auto}.country-map-chip{--country-tone:#0f766e;display:inline-flex;align-items:center;gap:7px;min-width:0;padding:6px 10px;border-radius:999px;background:color-mix(in srgb, var(--country-tone) 12%, #fff);border:1px solid color-mix(in srgb, var(--country-tone) 24%, #fff);color:var(--ink);font-size:11px;font-weight:850;line-height:1.1}.country-map-chip strong{color:var(--country-tone);font-weight:900;white-space:nowrap}.country-map-chip span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.country-dot{width:10px;height:10px;border-radius:999px;background:var(--country-tone);box-shadow:0 0 0 4px color-mix(in srgb, var(--country-tone) 18%, transparent)}.player-meta .country-map-chip{padding:5px 9px;font-size:10.5px}.metric-note .country-map-chip{max-width:100%}.metric-icon-compact{width:34px;height:34px;border-radius:12px}.metric-icon-compact svg{width:16px;height:16px}
.match-list{padding:8px}.match-card{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr);gap:14px;align-items:center;padding:16px;border-radius:18px;transition:.16s ease;position:relative}.match-card+.match-card{border-top:1px solid var(--line)}.match-card:hover{background:var(--surface-soft)}.match-card.clash{background:linear-gradient(90deg,rgba(0,163,92,.12),rgba(255,255,255,.82) 62%)}.match-card.live{box-shadow:inset 0 0 0 1px rgba(224,49,79,.24);background:linear-gradient(90deg,rgba(224,49,79,.11),rgba(255,255,255,.86))}.team{display:flex;gap:11px;align-items:center;min-width:0}.team.right{flex-direction:row-reverse}.team-meta{min-width:0}.team-name{font-size:15px;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;letter-spacing:-.02em}.team-name.right{text-align:right}.team-owner{display:flex;align-items:center;gap:5px;margin-top:4px;font-size:11px;font-weight:850;color:var(--muted)}.team-owner.right{flex-direction:row-reverse}.team-owner .avatar{box-shadow:0 0 0 1px rgba(255,255,255,.8);font-size:8px}.team-owner svg{width:12px;height:12px}.match-mid{min-width:92px;display:flex;flex-direction:column;align-items:center;gap:7px}.score{font-family:var(--font-display);font-size:28px;font-weight:800;line-height:1;letter-spacing:.02em}.vs{font-family:var(--font-display);font-size:13px;font-weight:800;color:var(--faint);letter-spacing:.12em}.match-time{font-size:10.5px;color:var(--faint);font-weight:850}.match-stats{display:flex;flex-wrap:wrap;justify-content:center;gap:6px;margin-top:8px;max-width:100%}.match-stat{display:inline-flex;align-items:center;gap:6px;max-width:100%;padding:5px 9px;border-radius:999px;background:var(--surface-soft);border:1px solid var(--line)}.match-stat span{font-size:9.5px;font-weight:900;text-transform:uppercase;letter-spacing:.06em;color:var(--faint)}.match-stat b{font-size:11px;font-weight:850;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.clash-note{display:flex;align-items:center;gap:5px;font-size:10.5px;color:var(--green-dark);font-weight:900}.clash-note svg{width:12px;height:12px}.flag-fallback{font-size:10px;font-weight:900;color:var(--faint)}.tag{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:4px 9px;font-size:10px;font-weight:950;letter-spacing:.07em;text-transform:uppercase}.tag.live{background:var(--red-soft);color:var(--red)}.tag.done{background:var(--green-soft);color:var(--green-dark)}.tag.soon{background:var(--surface-soft);color:var(--muted);border:1px solid var(--line-strong)}.tag.admin{background:var(--blue-soft);color:var(--blue)}
...
.group-table thead th{font-size:11px;letter-spacing:.05em;text-transform:uppercase;color:var(--muted)}.group-table tbody td{font-size:12px}.knockout-roadmap{display:grid;grid-template-columns:minmax(280px,.9fr) minmax(0,1.4fr);gap:16px;align-items:start}.knockout-stage-column,.knockout-bracket-column{display:grid;gap:14px}.knockout-stage-title{font-size:16px;font-weight:950;letter-spacing:-.03em}.knockout-stage-note{font-size:12px;color:var(--muted);font-weight:700;line-height:1.45}.knockout-group-list{display:grid;gap:10px}.knockout-group-card{background:#fff;border:1px solid var(--line);border-radius:18px;box-shadow:var(--shadow-xs);padding:14px 15px;display:grid;gap:10px}.knockout-group-head{display:flex;align-items:center;justify-content:space-between;gap:10px}.knockout-group-head strong{font-size:13px;font-weight:950}.knockout-group-body{display:grid;gap:8px}.knockout-group-line{display:flex;align-items:center;gap:8px;min-width:0}.knockout-rank{width:22px;height:22px;border-radius:999px;display:grid;place-items:center;font-size:10px;font-weight:950;color:#fff;flex:0 0 auto}.knockout-rank.gold{background:var(--gold)}.knockout-rank.silver{background:var(--silver)}.qualified-summary{background:linear-gradient(180deg,#fff,var(--surface-soft));border:1px solid var(--line);border-radius:18px;padding:15px;box-shadow:var(--shadow-xs)}.qualified-summary-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:10px}.qualified-summary-head strong{font-size:14px;font-weight:950}.qualified-count{font-size:11px;font-weight:900;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}.qualified-summary-body{display:grid;gap:12px}.qualified-row{display:grid;gap:8px}.qualified-group{font-size:12px;font-weight:950;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}.qualified-chips{display:flex;flex-wrap:wrap;gap:7px}.round32-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.round32-grid-tight{position:relative;padding-right:12px}.round32-grid-tight::after{content:"";position:absolute;right:0;top:12px;bottom:12px;width:2px;border-radius:999px;background:linear-gradient(180deg,transparent,rgba(15,118,110,.24),rgba(216,162,0,.26),transparent)}.round32-card{position:relative;background:#fff;border:1px solid var(--line);border-left:4px solid var(--tone,#0f766e);border-radius:18px;box-shadow:var(--shadow-xs);padding:14px;display:grid;gap:8px;min-height:132px}.round32-card::after{content:"";position:absolute;right:-14px;top:50%;width:14px;height:2px;background:linear-gradient(90deg,rgba(15,118,110,.35),rgba(15,118,110,0));transform:translateY(-50%)}.round32-top{display:flex;align-items:center;justify-content:space-between;gap:8px}.round32-match{font-size:12px;font-weight:950;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}.round32-round{font-size:10px;font-weight:950;color:var(--ink);background:var(--surface-soft);border:1px solid var(--line);border-radius:999px;padding:4px 8px}.round32-slot{min-width:0;padding:7px 9px;border-radius:12px;background:var(--surface-soft);border:1px solid var(--line);font-size:12px;font-weight:850;overflow:hidden;text-overflow:ellipsis}.round32-slot span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.round32-vs{font-size:10px;font-weight:950;color:var(--faint);text-transform:uppercase;letter-spacing:.08em;text-align:center}.knockout-future-panel{position:relative;background:linear-gradient(180deg,#fff,var(--surface-soft));border:1px solid var(--line);border-radius:20px;box-shadow:var(--shadow-xs);padding:15px;display:grid;gap:14px}.future-bracket{position:relative;display:grid;grid-template-rows:repeat(4,minmax(0,1fr));gap:10px;min-height:620px;padding-left:34px}.future-bracket::before{content:"";position:absolute;left:17px;top:12px;bottom:12px;width:2px;background:linear-gradient(180deg,rgba(15,118,110,.18),rgba(15,118,110,.26),rgba(216,162,0,.24),rgba(216,162,0,.18))}.future-node{position:relative;display:grid;align-content:center;gap:5px;min-height:128px;padding:14px 14px 14px 18px;background:#fff;border:1px solid var(--line);border-radius:18px;box-shadow:var(--shadow-xs)}.future-node::before{content:"";position:absolute;left:-18px;top:50%;width:18px;height:2px;background:linear-gradient(90deg,rgba(15,118,110,.34),rgba(15,118,110,0));transform:translateY(-50%)}.future-label{font-size:12px;font-weight:950;text-transform:uppercase;letter-spacing:.06em;color:var(--muted)}.future-node strong{font-size:20px;font-weight:950;letter-spacing:-.03em;color:var(--ink)}.future-node.knockout-final-card{justify-items:center;text-align:center;background:linear-gradient(135deg,rgba(2,162,92,.08),rgba(216,162,0,.12));border-color:color-mix(in srgb, var(--gold) 26%, #fff)}.future-node.knockout-final-card::before{background:linear-gradient(90deg,rgba(216,162,0,.32),rgba(216,162,0,0))}.future-node .bracket-final-badge{margin-bottom:4px}.future-connector{height:2px;margin-left:17px;margin-right:17px;background:linear-gradient(90deg,rgba(15,118,110,.25),rgba(216,162,0,.24));border-radius:999px}.knockout-final-card{background:linear-gradient(135deg,rgba(2,162,92,.08),rgba(216,162,0,.12));border-color:color-mix(in srgb, var(--gold) 26%, #fff)}@media(max-width:1200px){.group-grid{grid-template-columns:1fr}.knockout-roadmap{grid-template-columns:1fr}.round32-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.future-bracket{min-height:unset;grid-template-rows:none;padding-left:0}.future-bracket::before{display:none}.future-node{min-height:unset}.future-node::before{display:none}.knockout-future-panel{padding:14px}}@media(max-width:640px){.round32-grid{grid-template-columns:1fr}.round32-card{min-height:unset}.qualified-summary-head{align-items:flex-start;flex-direction:column}.future-node{padding:12px}}.onbehalf{margin-top:14px;padding-top:14px;border-top:1px dashed var(--line-strong)}.onbehalf-label{display:flex;align-items:center;gap:6px;font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.07em;color:var(--blue);margin-bottom:9px}.onbehalf-label svg{width:13px;height:13px}.onbehalf-btns{display:flex;flex-wrap:wrap;gap:7px}.ob-btn{display:inline-flex;align-items:center;gap:5px;border:1.5px solid var(--blue-soft);background:var(--blue-soft);color:var(--blue);border-radius:11px;padding:7px 11px;font-size:12px;font-weight:850;cursor:pointer;transition:.14s;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ob-btn:hover{background:var(--blue);color:#fff;border-color:var(--blue)}.ob-btn svg{width:13px;height:13px;flex:0 0 auto}
...
const MY_VOTES_KEY = "dhi-office-world-cup:my-votes";
const MY_POLL_KEY = "dhi-office-world-cup:my-poll";
...
function extractEspnScoring(summary) {
  ...
  const penalties = [];
  const timeline = [];
  const inferTeam = (event, participants) => sanitizeText(
    event?.team?.displayName
    || event?.team?.name
    || participants?.[0]?.team?.displayName
    || participants?.[0]?.athlete?.team?.displayName
    || participants?.[0]?.athlete?.team?.name
    || ""
  ).trim();
  scoringEvents.forEach((event) => {
    ...
    const team = inferTeam(event, participants);
    const isPenalty = Boolean(event.penaltyKick) || /penalt/i.test(String(event.text || "")) || /penalt/i.test(String(event.shortText || ""));
    if (scorer) goals.push({ name: scorer, team });
    if (assist) assists.push({ name: assist, team });
    if (isPenalty && scorer) penalties.push({ name: scorer, team });
    timeline.push({
      scorer,
      assist,
      team,
...
async function fetchTournamentStats() {
  ...
  const add = (bucket, entry) => {
    const key = sanitizeText(entry?.name || entry || "").trim();
    if (!key) return;
    const existing = bucket.get(key) || { name: key, count: 0, team: sanitizeText(entry?.team || "").trim() };
    bucket.set(key, {
      name: key,
      count: existing.count + 1,
      team: existing.team || sanitizeText(entry?.team || "").trim(),
    });
  };
  ...
  summaries.filter(Boolean).forEach(({ match, scoring }) => {
    ...
    scoring.goals.forEach((entry) => add(counters.goals, entry));
    scoring.assists.forEach((entry) => add(counters.assists, entry));
    scoring.penalties.forEach((entry) => add(counters.penalties, entry));
  });
...
function countryTone(country) {
  const palette = ["#0f766e", "#2563eb", "#7c3aed", "#d97706", "#dc2626", "#059669", "#0ea5e9", "#9333ea"];
  const value = String(country || "").split("").reduce((sum, char) => sum + char.charCodeAt(0), 0);
...
function statList(value) {
  if (Array.isArray(value)) {
    return value.map((item) => {
      if (item && typeof item === "object") {
        return {
          name: sanitizeText(String(item.name || "")).trim(),
          team: sanitizeText(String(item.team || "")).trim(),
        };
      }
      return { name: sanitizeText(String(item)).trim(), team: "" };
    }).filter((item) => item.name);
  }
  if (typeof value === "string") {
    return value
      .split(/\n|,/)
      .map((item) => ({ name: sanitizeText(item).trim(), team: "" }))
      .filter((item) => item.name);
  }
  return [];
}
...
function statSummary(value) {
  ...
  list.forEach((item) => counts.set(item.name, (counts.get(item.name) || 0) + 1));
  return [...counts.entries()].map(([name, count]) => (count > 1 ? `${name} x${count}` : name)).join(", ");
}

function buildStatLeaderboard(matches, field) {
  const counts = new Map();
  matches.forEach((match) => {
    if (match.status !== "completed") return;
    matchStatList(match, field).forEach((entry) => {
      const key = entry?.name || "";
      if (!key) return;
      const current = counts.get(key) || { name: key, count: 0, team: entry.team || "" };
      counts.set(key, {
        name: key,
...
function saveLocalVotes(key, value) {
  if (typeof window === "undefined") return;
  try {
    window.localStorage?.setItem(key, JSON.stringify(value || {}));
  } catch {
    // Shared state still persists the vote if browser storage is blocked.
  }
}

function loadUserLocalVotes(key, userName) {
...
function saveUserLocalVotes(key, userName, value) {
  if (typeof window === "undefined" || !userName) return;
  try {
    const current = loadLocalVotes(key);
  ...
  return (
    <div className={`match-card ${clash ? "clash" : ""} ${match.status === "live" ? "live" : ""}`}>
      ...
      <div className="match-mid">
        ...
        {(goals.length || assists.length || penalties.length) && (
          <div className="match-stats">
            {goals.length > 0 && <div className="match-stat"><span>Goals</span><b>{statSummary(goals)}</b></div>}
            {assists.length > 0 && <div className="match-stat"><span>Assists</span><b>{statSummary(assists)}</b></div>}
            {penalties.length > 0 && <div className="match-stat"><span>Penalties</span><b>{statSummary(penalties)}</b></div>}
          </div>
        )}
          ...
          <section className="panel">
            ...
            <div className="metric-grid" style={{ marginBottom: 0 }}>
              {[
                ...
                ["Assists", boards.assists[0], Swords],
                ["Penalty goals", boards.penalties[0], Shield],
              ].map(([label, item, Icon]) => {
                const player = players.find((entry) => entry.name === item?.name);
                return (
                  <div className="metric" key={label}>
                    <div className="metric-icon" style={{ background: "var(--surface-soft)" }}><Icon style={{ color: "var(--green-dark)" }} /></div>
                    <div className="metric-value">{item ? item.count : 0}</div>
                    <div className="metric-label">{label}</div>
                    <div className="metric-note">{item ? <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}><Avatar name={item.name} size={18} img={player?.avatar} />{item.name}</span> : "No scorer data yet"}</div>
                  </div>
                );
              })}
            </div>
...
function Stats({ players, matches, stats }) {
  ...
  const [panel, setPanel] = useState("scorers");
  const tabs = [
    ["goals", "Goals", Target],
  ...
  const countryRows = useMemo(() => {
    ...
    matches.forEach((match) => {
      if (match.status !== "completed" || !match.stage?.startsWith("Group") || match.sa == null || match.sb == null) return;
      const a = byCountry.get(match.a);
      const b = byCountry.get(match.b);
      if (!a || !b) return;
      a.played += 1;
      b.played += 1;
      a.gf += match.sa;
  ...
  const renderTop = (item, label, Icon) => {
    ...
    return (
      <div className="metric metric-accent">
        <div className="metric-icon metric-icon-compact" style={{ background: "var(--surface-soft)" }}><Icon style={{ color: "var(--green-dark)" }} /></div>
        <div className="metric-value">{item ? item.count : 0}</div>
        <div className="metric-label">{label}</div>
          ...
          {item ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              <span className="country-map-chip" style={{ "--country-tone": mapped.tone }}>
                {item.team ? <Flag country={item.team} size={14} round /> : <span className="country-dot" />}
    ...
    <section className="panel pad" style={{ marginBottom: 18 }}>
      ...
      <div className="knockout-roadmap">
        ...
        <div className="knockout-bracket-column">
          <div className="knockout-bracket-round">
            <div className="knockout-stage-title">Round of 32</div>
            <div className="knockout-stage-note">Official match slots from the FIFA bracket. The connectors point forward to empty rounds.</div>
            <div className="round32-grid round32-grid-tight">
              {roundOf32Matches.map((item) => (
                <div className="round32-card" key={`r32-${item.match}`} style={{ "--tone": item.tone }}>
          ...
          <div className="knockout-future-panel">
            ...
            <div className="knockout-stage-note">Leave these empty until the round of 32 is complete.</div>
      ...
      <section className="stats-hero panel">
        <div className="stats-hero-top">
          ...
          <div className="stats-badges">
            ...
            <span className="stats-badge"><span className="stats-mini-icon"><Swords size={12} /></span>{topAssist ? `${topAssist.name} · ${topAssist.count}` : "Waiting for sync"}</span>
            <span className="stats-badge"><span className="stats-mini-icon"><Shield size={12} /></span>{topPenalty ? `${topPenalty.name} · ${topPenalty.count}` : "Waiting for sync"}</span>
          </div>
        </div>
      </section>
      <section className="panel pad" style={{ marginBottom: 18 }}>
...
function AdminAnalytics({ analytics, verificationRequests }) {
  ...
  const now = Date.now();
  const visitors = [...sessions].sort((a, b) => Number(b.lastSeenAt || 0) - Number(a.lastSeenAt || 0)).reduce((list, item) => {
    const key = item.visitorId || item.id;
    if (!key || list.some((visitor) => (visitor.visitorId || visitor.id) === key)) return list;
    return [...list, item];
  }, []);
  const active = visitors.filter((item) => now - Number(item.lastSeenAt || 0) < 5 * 60 * 1000);
  const today = new Date().toISOString().slice(0, 10);
  const todayVisitors = visitors.filter((item) => new Date(item.startedAt || item.lastSeenAt || 0).toISOString().slice(0, 10) === today);
  const byRole = visitors.reduce((acc, item) => ({ ...acc, [item.role || "visitor"]: (acc[item.role || "visitor"] || 0) + 1 }), {});
  const byTab = active.reduce((acc, item) => ({ ...acc, [item.tab || "unknown"]: (acc[item.tab || "unknown"] || 0) + 1 }), {});
  ...
  const rows = visitors.slice(0, 80);
  ...
  return (
    <div>
      <div className="metric-grid">
        <Metric icon={Activity} value={active.length} label="Active now" note="Unique visitors seen in last 5 minutes" />
        <Metric icon={Users} value={visitors.length} label="Visitors" note={`${todayVisitors.length} today, ${sessions.length} sessions saved`} />
      ...
      <div className="dashboard-grid">
        <section className="panel pad">
          <div className="section-title" style={{ marginBottom: 12 }}><Users />Visitors by role</div>
          {Object.entries(byRole).map(([label, value]) => bar(label, value, maxRole))}
        </section>
        <section className="panel pad">
          <div className="section-title" style={{ marginBottom: 12 }}><LayoutGrid />Active page activity</div>
          {Object.entries(byTab).length ? Object.entries(byTab).map(([label, value]) => bar(label, value, maxTab)) : <div className="modal-sub" style={{ margin: 0 }}>No active visitors in the last 5 minutes.</div>}
        </section>
      </div>
...
function Admin({ players, matches, announcements, verificationRequests, analytics, onVerifyRequest, onMatch, onPlayer, onAvatar, onAnnAdd, onAnnDel, live, autoMode, setAutoMode, storeOn }) {
  ...
  const [drafts, setDrafts] = useState(() => Object.fromEntries(matches.map((match) => [match.id, {
    sa: match.sa ?? 0,
    sb: match.sb ?? 0,
    goals: statSummary(match.goals),
    assists: statSummary(match.assists),
    penalties: statSummary(match.penalties),
  }])));

  useEffect(() => {
    setDrafts(Object.fromEntries(matches.map((match) => [match.id, {
      sa: match.sa ?? 0,
      sb: match.sb ?? 0,
      goals: statSummary(match.goals),
      assists: statSummary(match.assists),
  ...
  return (
    <div className="rise">
      ...
      {tab === "matches" && (
        <section className="panel table-wrap">
          <table className="admin-table">
            <thead><tr><th>Match</th><th>Date</th><th>Status</th><th>Score</th><th>Scorers</th><th className="right">Action</th></tr></thead>
...
export default function App() {
  ...
  useEffect(() => {
    if (!me?.name) return;
    setMyVotes(loadUserLocalVotes(MY_VOTES_KEY, me.name));
    setMyPoll(loadUserLocalVotes(MY_POLL_KEY, me.name));
  }, [me?.name]);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (!pending?.id && !pending?.visitorId) return;
    const approved = verificationRequests.find((item) => item.id === pending.id || (item.visitorId === pending.visitorId && item.name === pending.name));
    if (approved?.status === "approved") {
      const nextUser = { name: approved.name, role: "player", verified: true, visitorId: approved.visitorId || pending.visitorId };
      setMe(nextUser);
      saveLocalUser(nextUser);
      savePendingRequest(null);
      setShowSignIn(false);
  ...
  const onVote = (matchId, choice) => {
    ...
    setMyVotes((previous) => {
      const next = { ...previous, [matchId]: choice };
      saveUserLocalVotes(MY_VOTES_KEY, me.name, next);
      return next;
    });
    setVotes((previous) => {
  ...
  const onPoll = (pollId, option) => {
    ...
    setMyPoll((previous) => {
      const next = { ...previous, [pollId]: option };
      saveUserLocalVotes(MY_POLL_KEY, me.name, next);
      return next;
    });
