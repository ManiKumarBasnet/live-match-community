      ...
      <div className="knockout-roadmap">
        ...
        <div className="knockout-bracket-column">
          <div className="knockout-bracket-round">
            ...
            <div className="knockout-stage-note">Official match slots from the FIFA bracket.</div>
            <div className="round32-grid">
          ...
          <div className="knockout-future-grid">
            <div className="knockout-future-card">
              <div className="knockout-stage-title">Round of 16</div>
              <div className="knockout-stage-note">Will fill after the round of 32 is decided.</div>
              <div className="future-lane">TBD</div>
            </div>
            <div className="knockout-future-card">
              <div className="knockout-stage-title">Quarter-finals</div>
              <div className="knockout-stage-note">Waiting on round-of-16 winners.</div>
              <div className="future-lane">TBD</div>
            </div>
            <div className="knockout-future-card">
              <div className="knockout-stage-title">Semi-finals</div>
              <div className="knockout-stage-note">Do not project early.</div>
              <div className="future-lane">TBD</div>
            </div>
            <div className="knockout-future-card knockout-final-card">
              <div className="bracket-final-badge"><Trophy /></div>
              <div className="knockout-stage-title">Final</div>
              <div className="knockout-stage-note">Champion lane stays blank until the semifinals exist.</div>
              <div className="future-lane">TBD</div>
            </div>
          </div>
        </div>
